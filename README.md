## New Alpha Release Available: [Version 0.9.3.0](https://github.com/dotslashsoft/caspian-surveyor/releases/tag/v0.9.3.0)
...
1. Download `CaspianSurveyor-0.9.3.0-Setup.exe` from the GitHub Releases page.
